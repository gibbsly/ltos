...
#getting uuid
execute unless score type= ltos.main matches 3 run function ltos:specify_output/uuid
execute if score type= ltos.main matches 3 run function ltos:specify_output/owner
